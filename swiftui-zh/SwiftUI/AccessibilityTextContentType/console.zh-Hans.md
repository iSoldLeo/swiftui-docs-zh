---
来源： https://developer.apple.com/documentation/SwiftUI/AccessibilityTextContentType/console
抓取时间： 2025-12-03T06:49:32Z
---
...
- **fileSystem**：表示文件浏览器（如 macOS 中的 Finder 应用程序）使用的文本的类型。
