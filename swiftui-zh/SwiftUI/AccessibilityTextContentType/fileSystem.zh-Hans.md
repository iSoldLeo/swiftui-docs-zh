---
来源： https://developer.apple.com/documentation/SwiftUI/AccessibilityTextContentType/fileSystem
抓取时间： 2025-12-03T06:49:33Z
---
...
表示文件浏览器（如 macOS 中的 Finder 应用程序）使用的文本的类型。
...
- **messaging**：表示信息中使用的文本的类型，如在信息 app 中。
