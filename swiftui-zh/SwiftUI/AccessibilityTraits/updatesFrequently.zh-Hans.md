---
来源： https://developer.apple.com/documentation/SwiftUI/AccessibilityTraits/updatesFrequently
...
当您希望辅助技术在需要更新信息时轮询更改时，请使用此特性。例如，您可以使用该特性来描述秒表的读数。
...
- **startsMediaSession**：无障碍元素激活时会启动媒体会话。
