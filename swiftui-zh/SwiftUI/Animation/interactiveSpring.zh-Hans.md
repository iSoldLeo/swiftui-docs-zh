---
来源： https://developer.apple.com/documentation/SwiftUI/Animation/interactiveSpring
抓取时间： 2025-12-03T06:12:17Z
---
...
一个方便的`spring`动画，具有较低的`duration`值，用于驱动交互式动画。
...
- **interactiveSpring(response:dampingFraction:blendDuration:)**：方便使用较低`response` 值的`spring` 动画，用于驱动交互式动画。
