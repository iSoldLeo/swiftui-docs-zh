---
来源： https://developer.apple.com/documentation/SwiftUI/BorderedProminentButtonStyle
...
使用 [borderedProminent](PrimitiveButtonStyle/borderedProminent.zh-Hans.md) 构建此样式。
...
Use [borderedProminent](PrimitiveButtonStyle/borderedProminent.zh-Hans.md) to construct this style.

## Creating the button style

- **init()**: Creates a bordered prominent button style.
