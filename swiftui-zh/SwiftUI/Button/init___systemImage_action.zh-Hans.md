--- 来源：https://developer.apple.com/documentation/SwiftUI/Button/init(_:systemImage:action:)

抓取时间：2025-12-01T02:38:53Z
...
创建一个按钮，该按钮的标签由本地化的字符串键和系统映像名称生成。
