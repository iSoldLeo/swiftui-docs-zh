--- 来源：https://developer.apple.com/documentation/SwiftUI/Button/init(_:systemImage:role:action:)

抓取时间：2025-12-02T21:48:05Z
...
创建一个具有指定角色的按钮，该按钮的标签由本地化字符串键和系统图像生成。
...
- **role**：按钮的可选语义角色。值为 `nil` 表示按钮未分配角色。
