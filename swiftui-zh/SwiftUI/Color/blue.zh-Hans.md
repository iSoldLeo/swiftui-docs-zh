---
来源： https://developer.apple.com/documentation/SwiftUI/Color/blue
抓取时间： 2025-12-03T05:39:37Z
---
...
- **black**：适合在用户界面元素中使用的黑色。
- **brown**：适合在用户界面元素中使用的与上下文相关的棕色。
- **clear**：适合在用户界面元素中使用的透明色。
- **cyan**：与上下文有关的青色，适合在用户界面元素中使用。
- **gray**：与上下文有关的灰色，适合在用户界面元素中使用。
- **green**：与上下文有关的绿色，适合在用户界面元素中使用。
- **indigo**：与上下文有关的靛蓝色，适合在用户界面元素中使用。
- **mint**：与上下文有关的薄荷色，适合在用户界面元素中使用。
- **orange**：与上下文有关的橙色，适合在用户界面元素中使用。
- **pink**：与上下文有关的粉红色，适合在用户界面元素中使用。
- **purple**：与上下文有关的紫色，适合在用户界面元素中使用。
- **red**：与上下文有关的红色，适合在用户界面元素中使用。
- **teal**：与上下文有关的茶色，适合在用户界面元素中使用。
- **white**：适合在用户界面元素中使用的白色。
- **yellow**：适合在用户界面元素中使用的白色：与上下文有关的黄色，适合在用户界面元素中使用。


---
source: https://developer.apple.com/documentation/SwiftUI/Color/blue
crawled: 2025-12-03T05:39:37Z
---
