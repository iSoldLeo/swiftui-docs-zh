---
来源： https://developer.apple.com/documentation/SwiftUI/CoordinateSpaceProtocol/global
抓取时间： 2025-12-03T06:33:46Z
---
...
- **local**：当前视图的局部坐标空间。
- **named(_:)**：当前视图的本地坐标空间：使用给定值创建命名坐标空间。
