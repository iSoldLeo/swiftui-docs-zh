--- 来源：https://developer.apple.com/documentation/SwiftUI/DefaultPickerStyle
...
您也可以使用 [automatic](PickerStyle/automatic.zh-Hans.md) 来构造此样式。
...
- **InlinePickerStyle**：一个 `PickerStyle`，其中每个选项都与其他视图一起显示在当前容器中。
...
You can also use [automatic](PickerStyle/automatic.zh-Hans.md) to construct this style.

## Creating the picker style

- **init()**: Creates a default picker style.
