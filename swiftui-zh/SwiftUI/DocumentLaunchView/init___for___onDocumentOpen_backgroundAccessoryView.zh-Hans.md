--- 来源：https://developer.apple.com/documentation/SwiftUI/DocumentLaunchView/init(_:for:_:onDocumentOpen:backgroundAccessoryView:)

抓取时间：2025-12-01T10:30:27Z
...
创建一个视图，用于在启动与文档相关的用户体验时显示，该视图包含本地化标题、自定义操作和后台辅助视图。
