--- 来源：https://developer.apple.com/documentation/SwiftUI/DocumentLaunchView/init(_:for:_:onDocumentOpen:backgroundAccessoryView:overlayAccessoryView:)

抓取时间：2025-12-03T05:41:20Z
...
创建一个视图，用于在使用本地化标题、自定义操作和辅助视图启动与文档相关的用户体验时显示。
...
- **backgroundAccessoryView**：返回视图背景辅助视图的视图构建器

- **overlayAccessoryView**：返回视图覆盖辅助视图的视图构建器
