--- 来源：https://developer.apple.com/documentation/SwiftUI/DocumentLaunchView/init(_:for:backgroundStyle:_:onDocumentOpen:overlayAccessoryView:)

抓取时间：2025-12-01T10:30:32Z
...
创建一个视图，用于在启动与文档相关的用户体验时显示，该视图包含本地化标题、自定义操作、背景样式和叠加辅助视图。
...
- **overlayAccessoryView**：用于返回视图的叠加辅助视图的视图构建器。
