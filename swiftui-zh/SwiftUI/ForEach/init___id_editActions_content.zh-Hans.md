---
来源：https://developer.apple.com/documentation/SwiftUI/ForEach/init(_:id:editActions:content:)
...
- **init(_:editActions:content:)**：创建一个唯一标识的实例，并根据底层数据的标识创建跨更新的视图。
