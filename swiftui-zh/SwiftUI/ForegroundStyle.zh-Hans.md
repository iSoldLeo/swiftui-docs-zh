---
来源： https://developer.apple.com/documentation/SwiftUI/ForegroundStyle
...
您也可以使用 [foreground](ShapeStyle/foreground.zh-Hans.md) 构建这种样式。
...
- **SelectionShapeStyle**：用于按照平台常规颜色和行为直观表示选择的样式。
...
---
source: https://developer.apple.com/documentation/SwiftUI/ForegroundStyle
...
You can also use [foreground](ShapeStyle/foreground.zh-Hans.md) to construct this style.

## Creating a foreground style

- **init()**: Creates a foreground style instance.
