--- 来源：https://developer.apple.com/documentation/SwiftUI/Gauge/init(value:in:label:currentValueLabel:minimumValueLabel:maximumValueLabel:markedValueLabels:)

抓取时间：2025-12-03T05:41:38Z
...
- **init(value:in:label:currentValueLabel:markedValueLabels:)**：创建一个表示指定范围内数值的仪表。

- **init(value:in:label:currentValueLabel:minimumValueLabel:maximumValueLabel:)**：创建一个显示指定范围内数值的仪表，并描述该仪表的当前值、最小值和最大值。
