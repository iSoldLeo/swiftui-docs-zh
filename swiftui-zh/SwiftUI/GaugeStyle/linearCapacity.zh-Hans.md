---
来源： https://developer.apple.com/documentation/SwiftUI/GaugeStyle/linearCapacity
抓取时间： 2025-12-03T06:10:05Z
---
...
一种仪表盘样式，随着仪表盘当前值的增加，从前缘到后缘显示一个填充条。
...
- **accessoryLinear**：一种仪表样式，显示带有标记的条形图，标记出现在条形图上的某一点，用于指示仪表的当前值。
