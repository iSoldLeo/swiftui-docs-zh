---
来源： https://developer.apple.com/documentation/SwiftUI/GestureState/init(wrappedValue:)
抓取时间： 2025-12-01T11:33:35Z
---
...
- **init(initialValue:)**：创建一个视图状态，该视图状态源自一个带有初始值的手势。
...
- **init(wrappedValue:reset:)**：创建一个视图状态，该视图状态派生于一个手势，并带有一个包裹状态值和一个提供事务重置的闭包。
