---
来源：https://developer.apple.com/documentation/SwiftUI/HoverEffectPhaseOverride/activeTemporarily(触发器：)
抓取时间： 2025-12-01T11:34:21Z
---
...
使用 `activeTemporarily(trigger:)` 可以覆盖特效的阶段，直到它完全过渡到活动阶段。该过渡将使用特效定义的动画，但会忽略任何延迟。

覆盖到期后，特效将再次响应悬停事件。如果视图被悬停，特效将保持在活动阶段。否则，它将开始过渡到非活动阶段，并遵守特效上定义的任何延迟。
