---
来源：https://developer.apple.com/documentation/SwiftUI/ImmersiveSpace/init(id:for:content:defaultValue:)
抓取时间：2025-12-01T02:38:12Z
---
...
为指定类型的展示数据创建与标识符相关联的沉浸式空间，如果未设置数据，则创建默认值。
...
空间使用指定的内容创建器来创建内容。当您的应用程序使用 [openImmersiveSpace](../EnvironmentValues/openImmersiveSpace.zh-Hans.md) 操作显示指定的 `type` 值时，会调用该初始化器。
