--- 来源：https://developer.apple.com/documentation/SwiftUI/LinearCapacityGaugeStyle
...
使用 [linearCapacity](GaugeStyle/linearCapacity.zh-Hans.md) 来构造此样式。
...
Use [linearCapacity](GaugeStyle/linearCapacity.zh-Hans.md) to construct this style.

## Creating the gauge style

- **init()**: Creates a linear capacity gauge style.
