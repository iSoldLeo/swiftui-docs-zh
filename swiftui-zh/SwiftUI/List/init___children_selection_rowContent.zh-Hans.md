--- 来源：https://developer.apple.com/documentation/SwiftUI/List/init(_:children:selection:rowContent:)

抓取时间：2025-12-03T05:42:44Z
...
创建一个层级列表，该列表根据绑定到底层可识别数据集合的绑定按需计算其行，并允许用户始终选中一行。
