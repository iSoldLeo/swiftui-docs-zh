--- 来源：https://developer.apple.com/documentation/SwiftUI/MenuBarExtra/init(_:systemImage:content:)

抓取时间：2025-12-03T05:31:24Z
...
当用户从系统菜单栏中移除该项目时，应用程序将自动退出。因此，它不应与 `App` 中的其他场景类型一起使用。
