--- 来源：https://developer.apple.com/documentation/SwiftUI/MeshGradient/init(width:height:bezierPoints:colors:background:smoothsColors:colorSpace:)
...
创建一个新的渐变网格，该网格由二维彩色点组成，并显式指定贝塞尔曲线控制点。
