--- 来源：https://developer.apple.com/documentation/SwiftUI/MeshGradient/init(width:height:locations:colors:background:smoothsColors:colorSpace:)
...
- **locations**：位置数组，包含 `width x height` 个元素。
