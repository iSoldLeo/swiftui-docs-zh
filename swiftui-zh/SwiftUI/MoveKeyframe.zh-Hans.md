---
来源： https://developer.apple.com/documentation/SwiftUI/MoveKeyframe
...
- **KeyframeTrackContentBuilder**：从您在闭包中定义的关键帧创建关键帧轨迹内容的构建器。
...
- **init(_:)**: Creates a new keyframe using the given value.
