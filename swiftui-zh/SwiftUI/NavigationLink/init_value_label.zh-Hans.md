---
来源：https://developer.apple.com/documentation/SwiftUI/NavigationLink/init(value:label:)
抓取时间：2025-12-02T20:58:45Z
---
...
- **value**：要显示的可选值。当用户选择链接时，SwiftUI 会存储该值的副本。传递`nil` 值可禁用链接。
- **label**：描述此链接显示的视图的标签。
