---
来源：https://developer.apple.com/documentation/SwiftUI/NavigationSplitView/init(preferredCompactColumn:sidebar:content:detail:)
...
创建一个三列导航分割视图，当视图折叠为窄尺寸的单列时，可通过编程控制哪一列显示在顶部。
...
- **init(preferredCompactColumn:sidebar:detail:)**：创建双列导航拆分视图，当视图折叠为窄尺寸的单列时，可通过编程控制哪一列显示在顶部。
