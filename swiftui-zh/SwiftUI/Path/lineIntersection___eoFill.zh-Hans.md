---
来源：https://developer.apple.com/documentation/SwiftUI/Path/lineIntersection(_:eoFill:)
抓取时间： 2025-12-01T02:33:32Z
---
...
生成路径的直线就是这条路径中与`other`填充区域重叠的直线。
...
- **lineSubtraction(_:eoFill:)**：返回一条新路径，该路径的一条直线不会与给定路径的填充区域重叠。
