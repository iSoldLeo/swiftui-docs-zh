---
来源：https://developer.apple.com/documentation/SwiftUI/PointerStyle/rowResize(方向:)
...
- **directions**：可调整行大小的垂直方向。

## 讨论

您可以使用 [pointerStyle(_:)](../View/pointerStyle.zh-Hans.md) 修改器将此指针样式应用于单个视图或视图层次结构。
...
- **grabIdle**：适合表示在特定范围内拖动以重新定位内容（如平移大图像）的指针样式。
