---
来源： https://developer.apple.com/documentation/SwiftUI/PrimitiveButtonStyle/borderless
抓取时间： 2025-12-02T21:50:22Z
---
...
在 tvOS 中，当人们聚焦于无边框按钮时，按钮会以液态玻璃效果动画形式升起。当按钮获得焦点时，此按钮样式会在按钮内容的第一张图片上应用液态玻璃效果。要将该效果应用到按钮的另一个子视图，请将带有[highlight](../HoverEffect/highlight.zh-Hans.md) 效果的[hoverEffect(_:)](../View/hoverEffect.zh-Hans.md) 修改器应用到该子视图。有关更多信息，请参阅 [Creating-a-tvOS-media-catalog-app-in-SwiftUI](../Creating-a-tvOS-media-catalog-app-in-SwiftUI.zh-Hans.md)。
