---
来源： https://developer.apple.com/documentation/SwiftUI/PrimitiveButtonStyle/card
抓取时间： 2025-12-02T16:23:37Z
---
...
当按钮获得焦点时，此按钮样式会应用液态玻璃效果。该样式不会对其内容应用任何固有的填充，因此图像、文本和其他内容都会以边缘到边缘的方式显示。
...
- **glass**：不应用边框的按钮样式：根据按钮的上下文应用液态玻璃效果的按钮样式。
