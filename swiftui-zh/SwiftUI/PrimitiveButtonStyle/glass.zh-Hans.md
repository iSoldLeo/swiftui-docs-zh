---
来源： https://developer.apple.com/documentation/SwiftUI/PrimitiveButtonStyle/glass(_:)
抓取时间： 2025-12-02T21:50:24Z
---
...
该按钮样式应用了液态玻璃效果，您可以通过指定色调或变体来自定义该效果。在下面的示例中，按钮使用了透明的液体玻璃效果：
...
在 tvOS 中，无论按钮是否有焦点，该按钮样式都会应用液态玻璃效果。该样式类似于 [bordered](bordered.zh-Hans.md)样式。
...
In tvOS, this button style applies a Liquid Glass effect regardless of whether the button has focus. This style is similar to the [bordered](bordered.zh-Hans.md) style.
