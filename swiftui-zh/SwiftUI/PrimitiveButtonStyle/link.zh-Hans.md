---
来源： https://developer.apple.com/documentation/SwiftUI/PrimitiveButtonStyle/link
...
- **bordered**：根据按钮的上下文应用标准边框样式的按钮样式。
...
- **plain**：一种按钮样式，在空闲时不对其内容进行样式或装饰，但可应用视觉效果来指示按钮的按下、聚焦或启用状态。
