--- 来源：https://developer.apple.com/documentation/SwiftUI/ReferenceFileDocument/init(configuration:)

抓取时间：2025-12-03T05:58:28Z
...
当用户打开的文件类型与文档类型支持的文件类型之一匹配时，SwiftUI 会调用此初始化器。使用 `configuration` 输入的 [file](../FileDocumentReadConfiguration/file.zh-Hans.md) 属性来获取文档数据。反序列化数据，并将其存储在文档的数据结构中：
