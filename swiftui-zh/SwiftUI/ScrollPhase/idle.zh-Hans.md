--- 来源：https://developer.apple.com/documentation/SwiftUI/ScrollPhase/idle
...
- **ScrollPhase.decelerating**：减速阶段，此时用户已停止与滚动视图交互，滚动视图正在减速向最终目标位置滚动。

- **ScrollPhase.interacting**：交互阶段，此时用户正在与滚动视图交互。
