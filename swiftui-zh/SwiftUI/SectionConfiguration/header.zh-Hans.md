--- 来源：https://developer.apple.com/documentation/SwiftUI/SectionConfiguration/header

抓取时间：2025-12-03T06:41:45Z
...
值得注意的是，节头是 `SubviewsCollection`，而不是 `Subview`，因为它可以由多个子视图组成。这意味着在大多数情况下，子视图集合应该被视为一个集合（要么通过索引访问，要么使用 `ForEach`），或者应该将其包装在一个容器视图中，例如布局或其他自定义容器：
