--- 来源：https://developer.apple.com/documentation/SwiftUI/SelectionShapeStyle
抓取时间：2025-12-03T04:05:58Z
...
一种用于以视觉方式指示选中状态的样式，遵循平台约定的颜色和行为。
...
您也可以使用 [selection](ShapeStyle/selection.zh-Hans.md) 来构建此样式。
...
You can also use [selection](ShapeStyle/selection.zh-Hans.md) to construct this style.

## Creating a selection shape style

- **init()**: Creates a selection shape style.
