--- 来源：https://developer.apple.com/documentation/SwiftUI/Shader/Argument/float3(_:_:_:)
...
返回一个表示 MSL 值 `float3(x, y, z)` 的参数值。
...
---
source: https://developer.apple.com/documentation/SwiftUI/Shader/Argument/float3(_:_:_:)
