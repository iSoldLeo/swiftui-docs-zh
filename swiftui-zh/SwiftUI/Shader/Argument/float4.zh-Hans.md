--- 来源：https://developer.apple.com/documentation/SwiftUI/Shader/Argument/float4(_:_:_:_:)

抓取时间：2025-12-04T13:29:24Z
...
返回一个表示 MSL 值 `float4(x, y, z, w)` 的参数值。
