--- 来源：https://developer.apple.com/documentation/SwiftUI/ShapeStyle/indigo

抓取时间：2025-12-03T06:24:46Z
...
- **black**：一种适用于 UI 元素的黑色。

- **blue**：一种适用于 UI 元素的上下文相关的蓝色。

- **brown**：一种适用于 UI 元素的上下文相关的棕色。

- **clear**：一种适用于 UI 元素的透明色。

- **cyan**：适用于用户界面元素的上下文相关青色。

- **gray**：适用于用户界面元素的上下文相关灰色。

- **green**：适用于用户界面元素的上下文相关绿色。
...
- **teal**：一种上下文相关的青色，适用于用户界面元素。

- **white**：一种适用于用户界面元素的白色。

- **yellow**：一种上下文相关的黄色，适用于用户界面元素。


---
source: https://developer.apple.com/documentation/SwiftUI/ShapeStyle/indigo
crawled: 2025-12-03T06:24:46Z
---
