--- 来源：https://developer.apple.com/documentation/SwiftUI/ShapeStyle/quinary-swift.type.property

抓取时间：2025-12-03T06:25:16Z
...
此层级样式映射到当前前景样式的第五级；如果您未在视图环境中设置前景样式，则映射到默认前景样式的第五级。通常，您可以通过向 [foregroundStyle(_:)](../View/foregroundStyle.zh-Hans.md) 修饰符提供非层级样式来设置前景样式。

有关如何使用形状样式的信息，请参阅 [ShapeStyle](../ShapeStyle.zh-Hans.md)。

## 层级样式

- **secondary**：返回此形状样式的第二级。
