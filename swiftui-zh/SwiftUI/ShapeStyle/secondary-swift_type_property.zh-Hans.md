--- 来源：https://developer.apple.com/documentation/SwiftUI/ShapeStyle/secondary-swift.type.property

抓取时间：2025-12-03T06:25:14Z
...
此层级样式映射到当前前景样式的第二层级；如果您未在视图环境中设置前景样式，则映射到默认前景样式的第二层级。通常，您可以通过向 [foregroundStyle(_:)](../View/foregroundStyle.zh-Hans.md) 修饰符提供非层级样式来设置前景样式。
