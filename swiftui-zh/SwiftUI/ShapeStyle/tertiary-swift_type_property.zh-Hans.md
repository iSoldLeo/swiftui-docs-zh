--- 来源：https://developer.apple.com/documentation/SwiftUI/ShapeStyle/tertiary-swift.type.property
...
此层级样式映射到当前前景样式的第三级；如果您未在视图环境中设置前景样式，则映射到默认前景样式的第三级。通常，您可以通过向 [foregroundStyle(_:)](../View/foregroundStyle.zh-Hans.md) 修饰符提供非层级样式来设置前景样式。
