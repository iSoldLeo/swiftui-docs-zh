---
来源：https://developer.apple.com/documentation/SwiftUI/Slider/init(value:in:label:onEditingChanged:)
抓取时间： 2025-12-01T02:48:23Z
---
...
- **init(value:in:step:label:onEditingChanged:)**：创建一个滑块，从给定范围内选择一个值，以步进增量为准，并显示所提供的标签。
