...
- **init(value:in:step:onEditingChanged:minimumValueLabel:maximumValueLabel:label:)**：创建一个滑块，从给定范围内选择一个值，并按步长递增，显示提供的标签。


---
source: https://developer.apple.com/documentation/SwiftUI/Slider/init(value:in:onEditingChanged:minimumValueLabel:maximumValueLabel:label:)
crawled: 2025-12-02T21:57:48Z
---
