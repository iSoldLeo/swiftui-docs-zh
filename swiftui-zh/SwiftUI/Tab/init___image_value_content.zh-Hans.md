---
来源： https://developer.apple.com/documentation/SwiftUI/Tab/init(_:image:value:content:)
...
- **init(_:image:value:role:content:)**：创建一个选项卡，当选项卡视图的选择与该选项卡的值匹配时，该选项卡视图将显示该选项卡，并带有本地化字符串键标签。
