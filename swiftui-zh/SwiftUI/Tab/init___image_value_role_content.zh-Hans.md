---
来源： https://developer.apple.com/documentation/SwiftUI/Tab/init(_:image:value:role:content:)
抓取时间： 2025-12-01T00:43:46Z
...
创建一个标签页，当标签页视图的选择与标签页的值相匹配时，标签页视图会显示该标签页，并带有本地化的字符串关键字标签。
