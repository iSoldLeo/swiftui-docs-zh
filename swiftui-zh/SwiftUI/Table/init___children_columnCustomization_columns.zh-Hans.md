--- 来源：https://developer.apple.com/documentation/SwiftUI/Table/init(_:children:columnCustomization:columns:)

抓取时间：2025-12-01T00:43:08Z
...
创建一个层级式表格，该表格的行基于一组可识别数据以及指向该数据子元素的键路径进行计算。
