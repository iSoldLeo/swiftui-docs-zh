--- 来源：https://developer.apple.com/documentation/SwiftUI/Table/init(_:selection:sortOrder:columnCustomization:columns:)

抓取时间：2025-12-02T20:59:01Z
...
创建一个可排序的表格，该表格基于一组可识别的数据计算其行，支持选择多行，并且列可动态自定义。
