--- 来源：https://developer.apple.com/documentation/SwiftUI/Text/speechAlwaysIncludesPunctuation(_:)

抓取时间：2025-12-02T21:48:37Z
...
- **value**：一个布尔值，如果 VoiceOver 朗读文本中的所有标点符号，则将其设置为 `true`。默认值为 `true`。
