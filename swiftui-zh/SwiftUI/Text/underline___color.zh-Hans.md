--- 来源：https://developer.apple.com/documentation/SwiftUI/Text/underline(_:color:)

抓取时间：2025-12-02T21:48:27Z
...
- **isActive**：一个布尔值，指示文本是否带有下划线。

- **color**：下划线的颜色。如果 `color` 为 `nil`，则下划线使用默认的前景色。
