---
来源：https://developer.apple.com/documentation/SwiftUI/Toggle/init(_:sources:isOn:)
抓取时间：2025-12-02T21:54:36Z
---
...
创建一个代表值集合的切换器，该值集合的标签由本地化的字符串键生成。
...
- **init(sources:isOn:label:)**：创建一个带自定义标签的切换按钮，代表一个值集合。
- **init(_:image:sources:isOn:)**：创建代表值集合的切换按钮，该按钮的标签由本地化字符串键和图像资源生成。
