---
来源： https://developer.apple.com/documentation/SwiftUI/Transition/push(来自：)
抓取时间： 2025-12-03T06:16:06Z
---
...
创建一个过渡效果，当添加到视图时，该过渡效果将通过从指定边缘向内移动视图并使其渐变来实现插入视图的动画效果，以及通过向相反边缘移动视图并使其渐变来实现移除视图的动画效果。
...
- **blurReplace**：结合模糊和缩放效果，以动画方式插入或移除视图的转场效果。
