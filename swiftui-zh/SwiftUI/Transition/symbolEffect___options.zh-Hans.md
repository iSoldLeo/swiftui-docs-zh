---
来源： https://developer.apple.com/documentation/SwiftUI/Transition/symbolEffect(_:options:)
抓取时间： 2025-12-01T11:05:19Z
---
...
创建一个转换，将提供的效果应用于插入或移除的视图层次结构中的符号图像。其他视图不受此过渡影响。
...
- **blurReplace**：结合模糊和缩放效果，以动画形式插入或移除视图的转场。
