---
来源： https://developer.apple.com/documentation/SwiftUI/UnitCurve/easeInOut
...
一条贝塞尔曲线，开始时速度较慢，中间时速度加快，接近终点时速度再次减慢。
...
起点和终点控制点分别位于 (x: 0.42, y: 0) 和 (x: 0.58, y: 1)。

## 获取缓和曲线

- **easeIn**：贝塞尔曲线，开始时速度较慢，结束时速度加快。
- **easeOut**：开始时速度很快，接近终点时速度减慢的贝塞尔曲线。
- **circularEaseIn**：开始时速度较慢，临近终点时速度加快的曲线。
