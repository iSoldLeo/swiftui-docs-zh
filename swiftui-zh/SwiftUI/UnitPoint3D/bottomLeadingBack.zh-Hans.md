---
来源： https://developer.apple.com/documentation/SwiftUI/UnitPoint3D/bottomLeadingBack
抓取时间： 2025-12-03T06:35:28Z
---
...
在从左到右的语言环境中，前缘出现在左边；在从右到左的语言环境中，前缘出现在右边。

## 获取底点

- **bottomLeading**：在深度维度上以视图的底边为中心的点。
- **bottomLeadingFront**：位于视图前角底部的点。
- **bottomBack**：位于视图后下边缘水平居中的点。
- **bottom**：以视图底面深度维度水平居中的点。
- **bottomFront**：位于视图底面前缘水平居中的点。
- **bottomTrailingBack**：位于视图后底角的点。
- **bottomTrailing**：位于视图底部后缘深度尺寸中心的点。
- **bottomTrailingFront**：位于视图底部前角的点。


---
source: https://developer.apple.com/documentation/SwiftUI/UnitPoint3D/bottomLeadingBack
crawled: 2025-12-03T06:35:28Z
---
