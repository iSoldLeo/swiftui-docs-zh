--- 来源：https://developer.apple.com/documentation/SwiftUI/View/accessibilityAction(named:intent:)

抓取时间：2025-12-02T17:43:51Z
...
向视图添加一个名为 `name` 的辅助功能操作。操作允许 VoiceOver 等辅助技术通过调用该操作与视图进行交互。执行操作时，将调用 `intent`。
