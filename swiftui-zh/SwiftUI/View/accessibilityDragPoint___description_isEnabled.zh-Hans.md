--- 来源：https://developer.apple.com/documentation/SwiftUI/View/accessibilityDragPoint(_:description:isEnabled:)
...
- **point**：辅助技术开始拖拽交互的起始点。

- **description**：拖拽交互的描述。

- **isEnabled**：如果为 true，则应用辅助功能拖拽点；否则，辅助功能拖拽点保持不变。

## 讨论

当需要向用户提供拖放交互的描述时，请使用此修饰符。
...
- **accessibilityDropPoint(_:description:)**：辅助技术应使用的位置，用于结束拖放交互。
