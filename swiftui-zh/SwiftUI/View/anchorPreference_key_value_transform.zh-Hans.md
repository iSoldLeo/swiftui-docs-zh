--- 来源：https://developer.apple.com/documentation/SwiftUI/View/anchorPreference(key:value:transform:)

抓取时间：2025-12-02T17:32:30Z
...
为指定的偏好设置键设置一个值。该值是一个与当前坐标空间关联的几何值的函数，允许读取该值的用户将几何值转换为其本地坐标。
...
- **transformAnchorPreference(key:value:transform:)**：为指定的首选项键设置一个值。该值是键的当前值和与当前坐标空间关联的几何图形值的函数，允许读取该值的用户将几何图形转换为其本地坐标。


---
source: https://developer.apple.com/documentation/SwiftUI/View/anchorPreference(key:value:transform:)
crawled: 2025-12-02T17:32:30Z
---
