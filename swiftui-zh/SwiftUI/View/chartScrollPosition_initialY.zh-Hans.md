--- 来源：https://developer.apple.com/documentation/SwiftUI/View/chartScrollPosition(initialY:)

抓取时间：2025-12-01T10:23:37Z
...
设置图表沿 y 轴的初始滚动位置。一旦用户滚动图表，此方法的值将不再生效。
...
- **chartScrollPosition(initialX:)**：设置图表沿 x 轴的初始滚动位置。一旦用户滚动图表，此方法的值将不再生效。
