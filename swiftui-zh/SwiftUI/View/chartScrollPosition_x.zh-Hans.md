--- 来源：https://developer.apple.com/documentation/SwiftUI/View/chartScrollPosition(x:)
...
- **chartScrollPosition(initialX:)**：设置图表沿 x 轴的初始滚动位置。一旦用户滚动图表，此修饰符的值将不再生效。

- **chartScrollPosition(initialY:)**：设置图表沿 y 轴的初始滚动位置。一旦用户滚动图表，此修饰符的值将不再生效。
