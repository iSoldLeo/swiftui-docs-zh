--- 来源：https://developer.apple.com/documentation/SwiftUI/View/deleteDisabled(_:)

抓取时间：2025-12-02T17:39:49Z
...
- **EditActions**：视图可以向用户提供的一组针对数据集合的编辑操作。

- **EditableCollectionContent**：一个不透明的包装视图，为列表中的行添加编辑功能。
