--- 来源：https://developer.apple.com/documentation/SwiftUI/View/mapItemDetailPopover(isPresented:item:displaysMap:attachmentAnchor:)

抓取时间：2025-12-02T17:24:40Z
...
如果您希望系统自动选择弹出框箭头的最佳方向，请使用此修饰符。如果您希望为箭头指定特定边，请使用 [mapItemDetailPopover(isPresented:item:displaysMap:attachmentAnchor:arrowEdge:)](mapItemDetailPopover_isPresented_item_displaysMap_attachmentAnchor_arrowEdge.zh-Hans.md)。
