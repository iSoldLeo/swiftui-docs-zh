--- 来源：https://developer.apple.com/documentation/SwiftUI/View/mapItemDetailPopover(item:displaysMap:attachmentAnchor:)

抓取时间：2025-12-02T17:24:42Z
...
如果您希望系统自动选择弹出框箭头的最佳方向，请使用此修饰符。如果您希望为箭头指定特定边，请使用 [mapItemDetailPopover(item:displaysMap:attachmentAnchor:arrowEdge:)](mapItemDetailPopover_item_displaysMap_attachmentAnchor_arrowEdge.zh-Hans.md)。
...
Use this modifier if you want the system to choose the best orientation of the popover’s arrow. If you want to specify a particular edge for the arrow, use [mapItemDetailPopover(item:displaysMap:attachmentAnchor:arrowEdge:)](mapItemDetailPopover_item_displaysMap_attachmentAnchor_arrowEdge.zh-Hans.md).
