--- 来源：https://developer.apple.com/documentation/SwiftUI/View/navigationSplitViewColumnWidth(min:ideal:max:)

抓取时间：2025-12-02T16:15:50Z
...
将此修饰符应用于 [NavigationSplitView](../NavigationSplitView.zh-Hans.md) 中列的内容，以指定列的首选灵活宽度。如果需要指定固定宽度，请使用 [navigationSplitViewColumnWidth(_:)](navigationSplitViewColumnWidth.zh-Hans.md)。
...
Apply this modifier to the content of a column in a [NavigationSplitView](../NavigationSplitView.zh-Hans.md) to specify a preferred flexible width for the column. Use [navigationSplitViewColumnWidth(_:)](navigationSplitViewColumnWidth.zh-Hans.md) if you need to specify a fixed width.
