--- 来源：https://developer.apple.com/documentation/SwiftUI/View/onChange(of:initial:_:)

抓取时间：2025-12-02T17:32:13Z
...
当值发生变化时，将调用新版本的闭包，因此任何捕获的值都将从被观察值变为新值时开始更新。在以下代码示例中，当 `playState` 的模型发生变化时，`PlayerView` 会调用其模型。
