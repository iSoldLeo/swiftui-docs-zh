--- 来源：https://developer.apple.com/documentation/SwiftUI/View/payLaterViewAction(_:)

抓取时间：2025-12-02T17:25:02Z
...
设置 PayLaterView 的操作。参见 `PKPayLaterAction`。
...
- **AddPassToWalletButton**：提供一个按钮，允许用户向 Apple 钱包添加新的或现有的通行证。
...
- **payLaterViewDisplayStyle(_:)**：设置“先享后付”视图的显示样式。参见 `PKPayLaterDisplayStyle`。
...
---
source: https://developer.apple.com/documentation/SwiftUI/View/payLaterViewAction(_:)
crawled: 2025-12-02T17:25:02Z
---
