--- 来源：https://developer.apple.com/documentation/SwiftUI/View/payWithApplePayButtonStyle(_:)

抓取时间：2025-11-30T21:10:10Z
...
设置按钮使用的样式。（参见 `PayWithApplePayButtonStyle`）。
...
- **VerifyIdentityWithWalletButton**：一个显示用于呈现身份验证流程的按钮的类型。
