--- 来源：https://developer.apple.com/documentation/swiftui/view/perspectiverotationeffect(_:axis:anchor:anchorz:perspective:)

抓取时间：2025-12-03T06:27:33Z
...
使用此方法可创建围绕指定旋转轴在三维空间中旋转视图的效果。该修改器会将旋转后的二维内容投影到原始视图的平面上。使用 `perspective` 输入来控制渲染器的消失点。以下示例创建文本绕 y 轴旋转 45° 的效果：
