--- 来源：https://developer.apple.com/documentation/SwiftUI/View/productIconBorder()

抓取时间：2025-12-02T17:25:11Z
...
您可能需要将此方法应用于提供给 `ProductView` 或 `StoreView` 的图标。
...
- **onInAppPurchaseStart(perform:)**：添加一个操作，当用户在此视图内的 StoreKit 视图上点击购买按钮时执行。
