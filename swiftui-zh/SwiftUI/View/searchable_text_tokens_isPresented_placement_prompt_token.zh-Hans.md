--- 来源：https://developer.apple.com/documentation/SwiftUI/View/searchable(text:tokens:isPresented:placement:prompt:token:)
...
- **searchable(text:tokens:suggestedTokens:isPresented:placement:prompt:token:)**：将此视图标记为可搜索，支持文本、词元和搜索建议，并以编程方式显示。
