--- 来源：https://developer.apple.com/documentation/SwiftUI/View/subscriptionStorePickerItemBackground(_:)

抓取时间：2025-11-30T21:10:58Z
...
您还可以使用 [subscriptionStorePickerItemBackground(_:in:)](subscriptionStorePickerItemBackground___in.zh-Hans.md) 控制选择器项背景的形状。
...
You can also control the shape of the picker item background using [subscriptionStorePickerItemBackground(_:in:)](subscriptionStorePickerItemBackground___in.zh-Hans.md).
