--- 来源：https://developer.apple.com/documentation/swiftui/view/tabviewsidebarheader(content:)

抓取时间：2025-12-01T10:48:54Z
...
标题显示在侧边栏顶部，位于所有标签之前，并可随内容滚动。标题仅在 [TabView](../TabView.zh-Hans.md) 显示侧边栏时可见。
...
- **tabViewSidebarFooter(content:)**：向标签视图的侧边栏添加自定义页脚。
...
The header appears at the top of the sidebar before any tab labels and can scroll with the content. The header is only visible when the [TabView](../TabView.zh-Hans.md) is displaying the sidebar.
