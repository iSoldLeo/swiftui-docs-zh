--- 来源：https://developer.apple.com/documentation/SwiftUI/View/textInputCompletion(_:)

抓取时间：2025-11-30T21:20:27Z
...
当此视图用作文本输入建议时，将一个完整的字符串与其值关联起来。
...
使用此方法可将一个完整的字符串与文本输入建议列表上下文中的视图关联起来。当选择此视图时，系统会使用此值替换关联文本字段中当前正在编辑的部分文本。
