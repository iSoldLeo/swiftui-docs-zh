---
来源： https://developer.apple.com/documentation/SwiftUI/WKUserNotificationHostingController/subtitleColor
抓取时间： 2025-12-03T07:01:25Z
---
...
应用于简短外观界面中显示的字幕文本的颜色。如果是 `nil`，文本将使用默认的系统颜色。
