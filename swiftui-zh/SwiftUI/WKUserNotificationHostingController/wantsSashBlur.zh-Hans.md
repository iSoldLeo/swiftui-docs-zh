---
来源： https://developer.apple.com/documentation/SwiftUI/WKUserNotificationHostingController/wantsSashBlur
抓取时间： 2025-12-03T07:01:26Z
---
...
- **coalescedDescriptionFormat**：同一类型的多个通知同时到达时要显示的格式字符串。如果指定自定义字符串，则可以使用 %d 变量来反映通知的数量。如果 `nil` 格式将是系统默认格式。
