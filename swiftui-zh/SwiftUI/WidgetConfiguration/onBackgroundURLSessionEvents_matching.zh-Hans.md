---
来源：https://developer.apple.com/documentation/SwiftUI/WidgetConfiguration/onBackgroundURLSessionEvents(匹配:_:)
抓取时间：2025-12-03T06:05:48Z
---
...
- **urlSessionEvent**：一个闭包，包含一个名为 `identifier` 的字符串参数和一个名为 `completion` 的闭包。
