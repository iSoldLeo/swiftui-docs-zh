---
来源：https://developer.apple.com/documentation/SwiftUI/DocumentGroupLaunchScene/init(_:backgroundStyle:_:backgroundAccessoryView:)
抓取时间：2025-12-01T10:48:09Z
...
为基于文档的应用程序创建一个启动场景，该场景包含一个标题、一种背景样式、一组操作和一个背景配件视图。
