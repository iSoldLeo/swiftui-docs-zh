---
来源： https://developer.apple.com/documentation/swiftui/glassbuttonstyle
...
您也可以使用 [glass](PrimitiveButtonStyle/glass.zh-Hans.md) 构建这种样式。
...
- **GlassProminentButtonStyle**：一种按钮样式，可根据按钮的上下文应用突出的玻璃边框图案。
...
You can also use [glass](PrimitiveButtonStyle/glass.zh-Hans.md) to construct this style.

## Initializers

- **init()**: Creates a glass button style.
- **init(_:)**
