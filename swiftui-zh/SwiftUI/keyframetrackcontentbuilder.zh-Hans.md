---
来源： https://developer.apple.com/documentation/swiftui/keyframetrackcontentbuilder
...
- **KeyframeTrackContentBuilder.Conditional**：来自结果生成器的条件结果。
...
- **buildPartialBlock(accumulated:next:)**
- **buildPartialBlock(first:)**
- **KeyframeTrackContentBuilder.Conditional**: A conditional result from the result builder.
