--- 来源：https://developer.apple.com/documentation/SwiftUI/Scene/defaultSize(width:height:)

抓取时间：2025-11-30T21:06:17Z
...
如果您想以实例大小的形式指定尺寸输入，请改用 [defaultSize(_:)](defaultSize.zh-Hans.md)。
...
If you want to specify the size input in terms of size instance, use [defaultSize(_:)](defaultSize.zh-Hans.md) instead.
