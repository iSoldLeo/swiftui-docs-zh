--- 来源：https://developer.apple.com/documentation/SwiftUI/Scene/defaultSize(width:height:depth:)

抓取时间：2025-12-02T17:21:13Z
...
每个参数均以点为单位指定。体素场景的大小在创建后不可更改。

此修改器仅影响 visionOS 中具有体素样式的窗口。
