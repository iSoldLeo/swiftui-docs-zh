---
来源：https://developer.apple.com/documentation/SwiftUI/UIHostingController/viewWillTransition(to:with:)
抓取时间： 2025-12-03T06:58:50Z
---

# 查看WillTransition(to:with:) | 苹果开发者文档
...
实例方法# viewWillTransition(to:with:)
...
Instance Method# viewWillTransition(to:with:)
...
### [Responding to view-related events](/documentation/SwiftUI/UIHostingController/viewWillTransition(to:with:)#Responding-to-view-related-events)
